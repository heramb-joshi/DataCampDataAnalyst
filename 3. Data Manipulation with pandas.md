...
- In pandas, the tabular data is stored as dataFrame object
- Every column in the dataFrame contains the same data type but different column can contain different data types
...
>**Reading data and createing dataFrame from csv**
```python
import pandas as pd
new_dogs = pd.read_csv("new_dogs.csv")
print(new_dogs)
```
>**wrtinh dataFrame to csv**
```python
import pandas as pd
